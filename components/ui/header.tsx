      ...
      <div className="max-w-8xl mx-auto px-5 sm:px-6">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <nav className="hidden md:flex md:grow">
            ...
            <li>
                <Link href="#products" className="font-medium text-gray-600 hover:text-gray-900 px-5 py-3 flex items-center transition duration-150 ease-in-out">About Us</Link>
              </li>
              ...
              <li>
                <Link href="#leave_feedback" className="btn-sm text-gray-900 bg-gray-200 hover:bg-gray-800 ml-3">
              ...
              <li>
                <Link href="#contact_us" className="btn-sm text-gray-200 bg-gray-900 hover:bg-gray-800 ml-3">
