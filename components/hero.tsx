        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="max-w-3xl mx-auto text-center">
            <p className="text-xl text-gray-600 mb-8" data-aos="zoom-y-out" data-aos-delay="150">
              <b className="text-gray-900">We work with producers around the </b> quickly into a beautiful <b className="text-gray-900">SaaS, Apps, Directories, Blogs, Helpdesks</b> – no code required.
            </p>
