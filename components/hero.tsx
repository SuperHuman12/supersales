      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="hidden sm:flex justify-center items-center mt-8 sm:mb-0 mb-3 sm:mt-12 sm:w-[60%] mx-auto">
            <div className="flex-shrink-0 sm:block hidden"><img src="/imgs/testimonials/adjust_square_portrait.jpg" alt="Author's image" className="w-16 h-16 object-cover text-gray-300 bg-white rounded-full" /></div>
            <div className="ml-5">
              <div className="text-left">
                <p className="-mt-1 opacity-70">
                  <span className="mr-1 text-xl italic opacity-60 font-medium">"</span>With Helpkit we literally went
