...
export default function Testimonials() {
  return (
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h2 className="h2 mb-4">Trusted by 100's of companies all over the world</h2>
          ...
          <div className="max-w-sm md:max-w-4xl mx-auto grid gap-2 grid-cols-4 md:grid-cols-5">
            ...
            {/* Item */}
            <div className="flex items-center justify-center py-2 col-span-2 md:col-auto m-auto">
            ...
            {/* Item */}
            <div className="flex items-center justify-center py-2 col-span-2 md:col-auto m-auto col-start-2 col-end-4">
    ...
    <div className="flex-row-reverse items-start pt-6 mx-auto sm:flex">
        ...
        <div className="prose-sm text-gray-600 sm:prose sm:w-2/3 prose-indigo">
            ...
            <p className='my-2'>
                ...
                <br />
                Since I couldn't find the right solution – <strong className="text-gray-900">I built NotionBear</strong>. Sure, you can publish your Notion page on its own but it might come across as unprofessional. The messy Notion url, distracting links pointing to
