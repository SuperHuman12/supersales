      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-sm md:max-w-4xl mx-auto grid gap-2 grid-cols-4 md:grid-cols-5">
            ...
            {/* Item */}
            <div className="flex items-center justify-center py-2 col-span-2 md:col-auto m-auto w-1/2 md:w-full">
            ...
            {/* Item */}
            <div className="flex items-center justify-center py-2 col-span-2 md:col-auto m-auto w-1/2 md:w-full col-start-2 col-end-4">
